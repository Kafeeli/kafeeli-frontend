...
export default function AdminDashboard() {
  ...
  return (
    <AdminLayout title="لوحة التحكم الإدارية" fullName={data?.fullName} role={data?.role} profileImageUrl={data?.profileImageUrl}>
        ...
        <>
          ...
          <section className="mt-6 rounded-xl border border-[#C2C6D2] bg-white p-5">
            ...
            <dl className="mt-4 grid gap-4 text-sm sm:grid-cols-2 lg:grid-cols-3">
              <div><dt className="text-gray-500">نوع الحساب</dt><dd className="mt-1 font-bold">{data.role || "—"}</dd></div>
