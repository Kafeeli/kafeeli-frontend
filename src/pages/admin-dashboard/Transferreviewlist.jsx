...
//     accountOwner: "سارة عبد العزيز",
//     bankName: "بنك فلسطين",
//     accountNumber: "SA60****4592",
//     fieldLabel: "رقم الحساب / الآيبان",
//     guardianPhone: "+966 50 123 4567",
//     branch: "فرع الرمال",
//     iban: "SA 43 8000 0000 1234 5678 9012",
//     accountOrPhone: "0599213456",
//     avatar:
//       "https://ui-avatars.com/api/?name=Sara+AA&background=0D4B8E&color=fff",
//   },
//   {
//     name: "محمد التميمي",
//     email: "moh.tm@email.com",
//     accountOwner: "محمد التميمي",
//     bankName: "PALPAY",
//     accountNumber: "059****4592",
//     fieldLabel: "رقم الجوال المرتبط",
//     guardianPhone: "+966 59 000 4592",
//     branch: "—",
//     iban: "SA 12 9000 0000 4567 1234 8890",
//     accountOrPhone: "059****4592",
//     avatar:
//       "https://ui-avatars.com/api/?name=Mohammad+T&background=2DBCC3&color=fff",
//   },
//   {
//     name: "أحمد محمد",
//     email: "ahmed@email.com",
//     accountOwner: "أحمد محمد",
//     bankName: "بنك فلسطين",
//     accountNumber: "059****4592",
//     fieldLabel: "رقم الحساب / الآيبان",
//     guardianPhone: "+966 55 987 6543",
//     branch: "فرع غزة",
//     iban: "SA 21 8000 0000 9988 7766 5544",
//     accountOrPhone: "0559876543",
//     avatar:
//       "https://ui-avatars.com/api/?name=Ahmed+M&background=B07B11&color=fff",
//   },
// ];

// function generateMockItems() {
//   return Array.from({ length: 14 }, (_, i) => {
//     const profile = BASE_PROFILES[i % BASE_PROFILES.length];
//     return {
//       id: i + 1,
//       ...profile,
//       date: "24 أكتوبر 2023",
...
//           نواجه صعوبات تقنية في الاتصال بالخادم الرئيسي حاليًا. قد يكون ذلك بسبب
//           ضعف شبكة الإنترنت أو صيانة دورية للنظام.
//         </p>
//       </div>
//       <button
//         onClick={onRetry}
...
//         className="flex h-10 w-full shrink-0 items-center justify-center gap-2 rounded-md border-2 border-[#0D4B8E] px-4 text-sm font-bold text-[#0D4B8E] transition hover:bg-[#0D4B8E] hover:text-white cursor-pointer lg:w-auto"
//       >
//         <FiExternalLink />
...
//     setStatus("loading");
//     try {
//       // TODO: استبدل هذا بنداء API فعلي، مثال:
//       // const res = await fetch("/api/admin/transfers/pending");
//       // if (!res.ok) throw new Error("Failed");
//       // const data = await res.json();
//       await new Promise((resolve) => setTimeout(resolve, 800));
//       const data = generateMockItems();
...
//   const totalPages = Math.ceil(reviewItems.length / ITEMS_PER_PAGE);
...
//     // TODO: نداء API فعلي لاعتماد بيانات التحويل الخاصة بـ item.id
//     setReviewItems((prev) => prev.filter((i) => i.id !== item.id));
//     setSelectedItem(null);
//   };

//   const handleRequestEdit = (item, reason) => {
//     // TODO: نداء API فعلي لطلب تعديل بيانات التحويل الخاصة بـ item.id مع إرسال reason
//     setReviewItems((prev) => prev.filter((i) => i.id !== item.id));
//     setSelectedItem(null);
//   };
...
//       {status === "error" && <ErrorState onRetry={fetchReviewItems} />}
...
//             {pageItems.map((item) => (
//               <ReviewRow key={item.id} item={item} onReview={setSelectedItem} />
//             ))}
//           </div>
