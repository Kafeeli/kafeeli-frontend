    ...
    >
      ...
      >
        ...
        <p className="mb-4 text-right text-sm leading-6 text-[#6B7280]">
          يرجى كتابة سبب رفض هذه الوثيقة ليتم إعلام الوصي بالتفاصيل.
        </p>
        ...
        <div className="mt-5 flex flex-col-reverse gap-3 sm:flex-row">
          ...
          <button
            ...
            disabled={loading}
            className="flex h-11 flex-1 items-center justify-center gap-2 rounded-md bg-red-600 text-sm font-bold text-white transition hover:bg-red-700 disabled:opacity-60 cursor-pointer"
          >
            {loading ? "جارٍ الإرسال..." : "تأكيد الرفض"}
          </button>
        </div>
      </motion.div>
    </motion.div>
