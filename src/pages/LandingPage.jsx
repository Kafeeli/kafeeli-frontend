    ...
    <div dir="rtl" className="min-h-screen bg-[#F8F9FA]">
      ...
      <section id="home" className="relative min-h-[650px] overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {/* Overlay */}
          <div className="absolute inset-0 bg-[#031B35]/60" />

          {/* Gradient */}
          <div className="absolute inset-0 bg-gradient-to-l from-[#031B35]/95 via-[#06345A]/75 to-[#06345A]/20" />
        </div>
        ...
        >
          <div className="ml-auto w-full max-w-2xl text-right">
            ...
            >
              ...
              <span className="font-['Cairo'] font-medium leading-[18px]">
