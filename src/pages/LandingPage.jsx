...
export default function LandingPage() {
  ...
  const animateCount = (setCount, end) => {
   ...
   const orphans = [
  { id: 1, name: 'يوسف أحمد', age: '8 سنوات', location: 'غزة', image: orphan1 },
  { id: 2, name: 'سارة محمود', age: '10 سنوات', location: 'غزة', image: orphan2 },
  { id: 3, name: 'محمد خالد', age: '6 سنوات', location: 'غزة', image: orphan3 },
...
const steps = [
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#F8F9FA]">
      ...
      {/* Stats Section */}
      <section ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 lg:pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-[#424750] text-lg max-w-2xl mx-auto">
            نحن نؤمن بأن الصدقة أمانة، لذلك صممنا نظامنا ليكون الأكثر شفافية وأماناً في العالم العربي.
          </p>
        </div>
