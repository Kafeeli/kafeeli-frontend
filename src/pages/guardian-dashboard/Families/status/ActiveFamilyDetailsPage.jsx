...
function ActiveFamilyDetailsPage() {
  ...
  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    ...
    <button
      type="button"
      className="w-full sm:w-auto h-[44px] rounded-[8px] bg-[#003469] text-white font-[Cairo] text-[14px] font-bold px-5 flex items-center justify-center gap-2 hover:bg-[#053c74] transition shadow-[0_6px_14px_rgba(0,52,105,0.18)]"
    >
