...
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
  <div className="bg-white rounded-xl border border-gray-300 p-6 flex items-center justify-start gap-3 hover:shadow-md hover:border-gray-400 transition cursor-pointer">
    <div className="w-14 h-14 bg-green-50 rounded-4xl flex items-center justify-center">
      <FaEnvelope className="text-green-500 text-2xl" />
    </div>
    <div className="text-right">
      <p className="text-sm text-gray-500 mb-2">حالة البريد</p>
      <p className="text-base font-bold text-green-500">موثّق</p>
    </div>
  </div>
  <div className="bg-white rounded-xl border border-gray-300 p-6 flex items-center justify-start gap-3 hover:shadow-md hover:border-gray-400 transition cursor-pointer">
    <div className="w-14 h-14 bg-blue-50 rounded-4xl flex items-center justify-center">
      <FaShieldAlt className="text-blue-500 text-2xl" />
    </div>
    <div className="text-right">
      <p className="text-sm text-gray-500 mb-2">حالة الحساب</p>
      <p className="text-base font-bold text-black">نشط</p>
    </div>
  </div>
  <div className="bg-white rounded-xl border border-gray-300 p-6 flex items-center justify-start gap-3 hover:shadow-md hover:border-gray-400 transition cursor-pointer">
    ...
    <div className="text-right">
      ...
      <p className="text-base font-bold text-yellow-500">كفيل</p>
    </div>
  </div>
</div>
